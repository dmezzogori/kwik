...
def send_reset_password_email(email_to: str, email: str, token: str) -> None:
    ...
    template_file = Path(settings.EMAIL_TEMPLATES_DIR) / "reset_password.html"
...
def send_new_account_email(email_to: str, username: str, password: str) -> None:
    ...
    template_file = Path(settings.EMAIL_TEMPLATES_DIR) / "new_account.html"
...
def send_test_email(email_to: str) -> None:
    ...
    send_email(
        email_to=email_to,
        subject=subject,
        body="Only a test!!! CAN BE DELETED"
    )