...
class TestLoginEndpoints:
    ...
    def test_access_token_endpoint_with_invalid_credentials(self, client: TestClient, db_session, clean_db) -> None:
    ...
    def test_access_token_endpoint_with_valid_credentials(self, client: TestClient, db_session, clean_db) -> None:
    ...
    def test_test_token_endpoint_without_auth_returns_401(self, client: TestClient) -> None:
    ...
    def test_test_token_endpoint_with_valid_token(self, client: TestClient, db_session, clean_db) -> None:
...
class TestUserEndpointsWithoutAuth:
    ...
    def test_get_users_without_auth_returns_401(self, client: TestClient) -> None:
        """Test that getting users without auth returns 401."""
        response = client.get("/api/v1/users/")
        assert response.status_code == status.HTTP_401_UNAUTHORIZED

    def test_get_user_me_without_auth_returns_401(self, client: TestClient) -> None:
        """Test that getting current user without auth returns 401."""
        response = client.get("/api/v1/users/me")
        assert response.status_code == status.HTTP_401_UNAUTHORIZED

    def test_create_user_without_auth_returns_401(self, client: TestClient) -> None:
    ...
    def test_update_user_without_auth_returns_401(self, client: TestClient) -> None:
...
class TestAPIErrorHandling:
    ...
    def test_invalid_json_payload_returns_422(self, client: TestClient) -> None:
