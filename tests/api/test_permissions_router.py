...
class TestPermissionsRouter:
    ...
    def test_list_permissions_with_admin_permission(self, admin_client: TestClient) -> None:
    ...
    def test_list_permissions_with_pagination(self, admin_client: TestClient) -> None:
        """Test listing permissions with pagination parameters."""
        response = admin_client.get("/api/v1/permissions/?skip=0&limit=10")
    ...
    def test_list_permissions_without_permission(self, client: TestClient, regular_user: User) -> None:
    ...
    def test_create_permission_with_admin_permission(self, admin_client: TestClient) -> None:
    ...
    def test_create_permission_duplicate_name(self, admin_client: TestClient) -> None:
        """Test creating permission with duplicate name fails."""
        permission_data = {"name": "test_permission_duplicate"}

        # Create first permission
        response1 = admin_client.post("/api/v1/permissions/", json=permission_data)
        assert response1.status_code == HTTPStatus.OK

        # Try to create duplicate
        response2 = admin_client.post("/api/v1/permissions/", json=permission_data)
        assert response2.status_code == HTTPStatus.CONFLICT

    def test_create_permission_missing_name(self, admin_client: TestClient) -> None:
        """Test creating permission with missing required name field fails."""
        permission_data = {}
        response = admin_client.post("/api/v1/permissions/", json=permission_data)
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_create_permission_empty_name(self, admin_client: TestClient) -> None:
        """Test creating permission with empty name fails."""
        permission_data = {"name": ""}
        response = admin_client.post("/api/v1/permissions/", json=permission_data)
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_create_permission_without_permission(self, client: TestClient, regular_user: User) -> None:
    ...
    def test_get_permission_by_id_with_admin_permission(self, admin_client: TestClient) -> None:
        """Test getting permission by ID with admin permissions."""
        # Create test permission first
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_get_by_id")
        permission_id = created_permission["id"]

        response = admin_client.get(f"/api/v1/permissions/{permission_id}")
    ...
    def test_get_permission_by_id_nonexistent_permission(self, admin_client: TestClient) -> None:
        """Test getting non-existent permission by ID fails."""
        response = admin_client.get(f"/api/v1/permissions/{NONEXISTENT_PERMISSION_ID}")

        assert response.status_code == HTTPStatus.NOT_FOUND

    def test_get_permission_by_id_invalid_id(self, admin_client: TestClient) -> None:
        """Test getting permission with invalid ID format."""
        response = admin_client.get("/api/v1/permissions/invalid-id")
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_get_permission_by_id_without_permission(self, client: TestClient, regular_user: User) -> None:
    ...
    def test_update_permission_with_admin_permission(self, admin_client: TestClient) -> None:
        """Test updating permission with admin permissions."""
        # Create test permission first
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_update_before")
        permission_id = created_permission["id"]

        update_data = {"name": "test_permission_update_after"}
        response = admin_client.put(f"/api/v1/permissions/{permission_id}", json=update_data)
    ...
    def test_update_permission_nonexistent_permission(self, admin_client: TestClient) -> None:
        """Test updating non-existent permission by ID fails."""
        update_data = {"name": "test_permission_should_fail"}
        response = admin_client.put(f"/api/v1/permissions/{NONEXISTENT_PERMISSION_ID}", json=update_data)

        assert response.status_code == HTTPStatus.NOT_FOUND

    def test_update_permission_empty_data(self, admin_client: TestClient) -> None:
        """Test updating permission with empty data fails."""
        # Create test permission first
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_update_empty")
        permission_id = created_permission["id"]
    ...
    def test_update_permission_empty_name(self, admin_client: TestClient) -> None:
        """Test updating permission with empty name fails."""
        # Create test permission first
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_update_empty_name")
        permission_id = created_permission["id"]
    ...
    def test_update_permission_invalid_id(self, admin_client: TestClient) -> None:
        """Test updating permission with invalid ID format."""
        update_data = {"name": "test_permission_should_fail"}
        response = admin_client.put("/api/v1/permissions/invalid-id", json=update_data)
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_update_permission_without_permission(self, client: TestClient, regular_user: User) -> None:
    ...
    def test_get_permission_roles_with_admin_permission(self, admin_client: TestClient) -> None:
        """Test getting roles associated with a permission."""
        # Create test permission and role
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_roles")
        permission_id = created_permission["id"]
        self._create_test_role_via_api(admin_client, "test_role_for_permission")

        # Assign permission to role via API (assuming this endpoint exists)
        # For now, test the endpoint even without associations
        response = admin_client.get(f"/api/v1/permissions/{permission_id}/roles")
    ...
    def test_get_permission_roles_nonexistent_permission(self, admin_client: TestClient) -> None:
        """Test getting roles for non-existent permission fails."""
        response = admin_client.get(f"/api/v1/permissions/{NONEXISTENT_PERMISSION_ID}/roles")

        assert response.status_code == HTTPStatus.NOT_FOUND

    def test_get_permission_roles_invalid_id(self, admin_client: TestClient) -> None:
        """Test getting permission roles with invalid ID format."""
        response = admin_client.get("/api/v1/permissions/invalid-id/roles")
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_get_permission_roles_without_permission(self, client: TestClient, regular_user: User) -> None:
    ...
    def test_get_permission_available_roles_with_admin_permission(self, admin_client: TestClient) -> None:
        """Test getting available roles for a permission."""
        # Create test permission and role
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_available_roles")
        permission_id = created_permission["id"]
        self._create_test_role_via_api(admin_client, "test_available_role_for_permission")

        response = admin_client.get(f"/api/v1/permissions/{permission_id}/available-roles")
    ...
    def test_get_permission_available_roles_nonexistent_permission(self, admin_client: TestClient) -> None:
        """Test getting available roles for non-existent permission fails."""
        response = admin_client.get(f"/api/v1/permissions/{NONEXISTENT_PERMISSION_ID}/available-roles")

        assert response.status_code == HTTPStatus.NOT_FOUND

    def test_get_permission_available_roles_invalid_id(self, admin_client: TestClient) -> None:
        """Test getting permission available roles with invalid ID format."""
        response = admin_client.get("/api/v1/permissions/invalid-id/available-roles")
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_get_permission_available_roles_without_permission(self, client: TestClient, regular_user: User) -> None:
    ...
    def test_purge_permission_roles_with_admin_permission(self, admin_client: TestClient) -> None:
        """Test purging all role associations from a permission."""
        # Create test permission
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_purge_roles")
        permission_id = created_permission["id"]

        # Purge roles (even if no associations exist, should work)
        response = admin_client.delete(f"/api/v1/permissions/{permission_id}/roles")
    ...
    def test_purge_permission_roles_nonexistent_permission(self, admin_client: TestClient) -> None:
        """Test purging roles for non-existent permission fails."""
        response = admin_client.delete(f"/api/v1/permissions/{NONEXISTENT_PERMISSION_ID}/roles")

        assert response.status_code == HTTPStatus.NOT_FOUND

    def test_purge_permission_roles_invalid_id(self, admin_client: TestClient) -> None:
        """Test purging permission roles with invalid ID format."""
        response = admin_client.delete("/api/v1/permissions/invalid-id/roles")
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_purge_permission_roles_without_permission(self, client: TestClient, regular_user: User) -> None:
    ...
    def test_delete_permission_with_admin_permission(self, admin_client: TestClient) -> None:
        """Test deleting a permission with admin permissions."""
        # Create test permission
        created_permission = self._create_test_permission_via_api(admin_client, "test_permission_delete")
        permission_id = created_permission["id"]

        response = admin_client.delete(f"/api/v1/permissions/{permission_id}")
        ...
        get_response = admin_client.get(f"/api/v1/permissions/{permission_id}")
        assert get_response.status_code == HTTPStatus.NOT_FOUND

    def test_delete_permission_nonexistent_permission(self, admin_client: TestClient) -> None:
        """Test deleting non-existent permission fails."""
        response = admin_client.delete(f"/api/v1/permissions/{NONEXISTENT_PERMISSION_ID}")

        assert response.status_code == HTTPStatus.NOT_FOUND

    def test_delete_permission_invalid_id(self, admin_client: TestClient) -> None:
        """Test deleting permission with invalid ID format."""
        response = admin_client.delete("/api/v1/permissions/invalid-id")
        assert response.status_code == HTTPStatus.UNPROCESSABLE_ENTITY

    def test_delete_permission_without_permission(self, client: TestClient, regular_user: User) -> None:
